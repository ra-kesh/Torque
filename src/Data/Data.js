export const videoData = [
  {
    ...
    category: "stunt",
    desc: "Want to pop a wheelie but don't know how to pull it off? After watching this video you will know how to safely and correctly wheelie your motorcycle!  ",
  },
  {
    id: "RqfXAu0Vqmk",
    name: "How to do a Stoppie?",
    category: "stunt",
    desc: "The second tutorial of the #PulsarMania #ABCOfStunting series is here, and this time we'll show you how to do a Stoppie like the professionals. Watch the video, keep practicing and stay tuned for more awesome stunting action.",
  },
  {
    id: "fl9mfnpJ1wo",
    name: "How to do cornering?",
    category: "tips",
    desc: "Riders will often tell you it’s their bike that couldn’t handle the bend – the truth is most crashes that happen in corners happen because the rider couldn’t handle the bend. So what can you do to make sure you nail it? And how can your sixth sense help you stay in control?.",
  },
  {
    id: "TY37ctp6ExI",
    name: "How to jump a motorcycle!",
    category: "tips",
    desc: "In this chapter of the Pulsar Mania ABC of Stunting Series we teach you how to jump a motorcycle. This is an essential skill when you go off the beaten track or even when you go off road. We start with the basics - first walk the track or ride slowly and check out the obstacle that you want to jump over. Then start slow understand what the motorcycle is doing and then build up your speeds. The basic technique is pull in the clutch just before the jump and blip the throttle to lift the nose. Stand loose with the knees bent so the bent knee takes the impact of the landing and does not hit your spine. And never use the front brake when you are landing otherwise the bike will nose dive.",
  },
  {
    id: "JhTf7cBeGcs",
    name: "Understanding Motorcycle Clutch",
    category: "mechanism",
    desc: "This video explains the working of a Motorcycle Clutch with relevant animations. Motorcycle clutch is a component which enables the engine power to engage or disengage with the gearbox in gradual and safe manner.",
  },
  {
    id: "cM4YrRjKVUc",
